...
fn main() {
    ...
    // move forces the closure to take ownership of any variables used from the greater scope.
    ...
    // Get an error here: type annotations needed for crossbeam:sender<t>, crossbeam::receiver<t>
